            ...
            <div className="col-span-12 self-stretch me-8">
                <CardContent>
                    <div style={{display:"flex",justifyContent: "space-between",alignItems:"center"}}>
                        ...
                        <h2>
                            {(session && session.user && session.user.email && session.scopusID) && <Link href={`add`}>
                                    ...
                                    <div className="border-l-4 pl-3">
                                        ...
                                        >
                                            ...
                                            <div className="text-1xl" style={{display: "flex",alignContent:"center",justifyContent:"center",gap: "20px"}}>
                                                {(session && session.user && session.user.email && session.scopusID) && <Link href={`edit/${project._id}`} style={{margin: "0px",padding: "0px"}}>
                                                    <svg
                                                ...
                                                {(session && session.user && session.user.email && session.scopusID) && <DeleteButton id={project._id}/>}
                                            </div>
                                        </div>
                                        <div>
                                            <Link
